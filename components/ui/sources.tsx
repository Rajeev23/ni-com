  ...
  return (
    <HoverCardTrigger asChild>
      <a
        ...
        className={cn(
          "inline-flex h-6 max-w-32 items-center gap-1 overflow-hidden rounded-full bg-muted py-0 text-xs leading-none text-muted-foreground no-underline transition-colors duration-150 hover:bg-foreground/5 hover:text-primary",
...
export function SourceContent({
  ...
  return (
    <HoverCardContent
      className={cn(
        "w-80 rounded-lg border-transparent p-0 shadow-lg ring-1 ring-border-illustration",
        className
      )}
    >
      <a
