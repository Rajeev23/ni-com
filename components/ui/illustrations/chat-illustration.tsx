...
export const ChatIllustration = () => {
  ...
  return (
    <div aria-hidden className="flex flex-col gap-6">
      <div>
        <div className="relative before:absolute before:inset-0 before:border-y before:border-dashed before:border-foreground/10 before:mask-x-from-75%">
          <div className="relative mx-auto max-w-lg">
            <div className="ml-auto w-fit max-w-3/4 rounded-t-2xl rounded-br rounded-bl-2xl bg-linear-to-b from-card to-indigo-500/5 p-3 text-sm text-indigo-950 shadow-md ring-1 inset-ring shadow-indigo-600/10 ring-foreground/10 inset-ring-background/50 selection:bg-indigo-900/10 selection:text-indigo-700 dark:text-indigo-50/65 dark:selection:text-indigo-300">
      ...
      <div className="h-30">
        <div className="relative before:absolute before:inset-0 before:border-y before:border-dashed before:border-foreground/10 before:mask-x-from-75%">
          <div className="relative mx-auto max-w-lg">
            {isStreaming ? (
              <div className="w-fit max-w-3/4 rounded-t-2xl rounded-br-2xl rounded-bl bg-linear-to-b from-card to-emerald-500/5 p-3 text-sm text-emerald-950 shadow-md ring-1 inset-ring shadow-emerald-600/10 ring-foreground/10 inset-ring-background/50 selection:bg-emerald-900/10 selection:text-emerald-700 dark:text-emerald-50/65 dark:selection:text-emerald-300">
                <ResponseStream
                  textStream={response}
                  mode="typewriter"
                  className="text-sm"
